...
begin
  ...
  id:=154357;
  GameObjectTPL[id].Entry:=154357;
  GameObjectTPL[id].TypeID:=3;
  GameObjectTPL[id].DisplayID:=49;
  GameObjectTPL[id].Name[0]:='Glinting Mud';
