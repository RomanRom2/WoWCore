...
begin
  ...
  id:=86492;
  GameObjectTPL[id].Entry:=86492;
  GameObjectTPL[id].TypeID:=3;
  GameObjectTPL[id].DisplayID:=335;
  GameObjectTPL[id].Name[0]:='Crate of Elunite';
